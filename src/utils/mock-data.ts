...
export const mockNumberCards = [
  { title: '总资产规模', value: 285.36, prefix: '¥', suffix: '亿', trend: 'up' as const, trendValue: 12.5, color: '#00d4ff' },
  { title: '今日交易额', value: 16.82, prefix: '¥', suffix: '亿', trend: 'up' as const, trendValue: 8.3, color: '#00ff88' },
  { title: '活跃客户数', value: 48623, suffix: '户', trend: 'up' as const, trendValue: 5.7, color: '#ffa940' },
  { title: '不良贷款率', value: 1.52, suffix: '%', trend: 'down' as const, trendValue: 0.3, color: '#ff4d4f' },
  { title: '理财产品规模', value: 92.18, prefix: '¥', suffix: '亿', trend: 'up' as const, trendValue: 15.2, color: '#9254de' },
  { title: '本月营收', value: 3.65, prefix: '¥', suffix: '亿', trend: 'up' as const, trendValue: 9.8, color: '#36cfc9' },
]
